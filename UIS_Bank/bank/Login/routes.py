...
from bank.models import showmatches, showstadiums, showeuro, showgroups, showFranceMatches, showFranceStadiums, showFranceGroups, Matches, Stadium, Euro, Group, FranceMatches, FranceStadiums, FranceGroups
